...
class BubbleTest {
    ...
    // -------------------------------------------------------------------------
    // 2. Already-sorted / best-case (tests the swapped-flag early exit)
    // -------------------------------------------------------------------------
    ...
    // -------------------------------------------------------------------------
    // 3. Reverse-sorted input (worst case — maximum swaps)
    // -------------------------------------------------------------------------
    ...
    // -------------------------------------------------------------------------
    // 8. Stability: equal elements must retain their relative order
    //    (Verified indirectly through consistent output with duplicate keys)
    // -------------------------------------------------------------------------

    @Nested
    @DisplayName("Stability with duplicates")
    class Stability {
